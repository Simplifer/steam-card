      ...
      <div class="card"
          ...
          <div class="user-info">
            ...
            <div class="status">
              <div style="font-size:12px;font-weight:bold">
                  ${this.name} | ${this.accountYear}${this.i18n.get('account_years')}
              </div>
              <div style="font-size:12px;font-weight:bold">
                  LV. ${this.playerLevel}
              </div>
        ...
        <div class="bottom">
          <div style="font-size:12px;margin-bottom:12px">
              ${this.playTime} ${this.i18n.get('hours')} (${this.i18n.get('past_2_weeks')}) / ${this.totalTime} ${this.i18n.get('hours')} (${this.i18n.get('total_hours')})
          </div>
          <div class="game-list">
              ${this.gamesSvg}
          </div>
