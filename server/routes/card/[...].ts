import { getOwnedGames, getPlayerSummaries, getRecentlyPlayedGames, getSteamProfile } from 'server/core/request/steamApi'
...
export default defineEventHandler(async (event) => {
  try {
    ...
    const [player, playedGames, profile, allGames] = AllData
